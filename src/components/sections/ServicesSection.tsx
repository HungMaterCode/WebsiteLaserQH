...
const services = [
  ...
  { icon: Cpu, title: 'Lập Trình & Điều Khiển Show', subtitle: 'Show Programming & Control', description: 'Kỹ thuật viên chuyên nghiệp với grandMA3 console, lập trình đồng bộ toàn bộ show theo từng beat nhạc.', features: ['grandMA3 Console','Timecode Synchronization','MIDI & OSC Integration','Pre-programmed Cue Library','24/7 Technical Support'], image: 'https://images.unsplash.com/photo-1759496434742-771c92e66103?w=1200&q=80', color: '#BF00FF', colorDim: 'rgba(191,0,255,0.1)', tag: 'PROGRAMMING', gallery: ['https://images.unsplash.com/photo-1759496434742-771c92e66103?w=1200&q=80', 'https://images.unsplash.com/photo-1759912301996-3b99deda9996?w=1200&q=80', 'https://images.unsplash.com/photo-1753030768124-dba306907bba?w=1200&q=80'] },
  { icon: Star, title: 'Tư Vấn & Thiết Kế Concept', subtitle: 'Technical Consulting & Concept Design', description: 'Tư vấn giải pháp kỹ thuật toàn diện và thiết kế concept Visual / Lighting cho các buổi ra mắt sản phẩm, brand activation và không gian trải nghiệm.', features: ['Technical Solution Consulting','Creative Concept Development','Immersive Experience Design','3D Visual Motion Mapping','Brand Activation Strategy'], image: 'https://images.unsplash.com/photo-1763553113391-a659bee36e06?w=1200&q=80', color: '#FFD700', colorDim: 'rgba(255,215,0,0.1)', tag: 'DESIGN', gallery: ['https://images.unsplash.com/photo-1763553113391-a659bee36e06?w=1200&q=80', 'https://images.unsplash.com/photo-1759496434742-771c92e66103?w=1200&q=80', 'https://images.unsplash.com/photo-1753030768124-dba306907bba?w=1200&q=80'] },
];
