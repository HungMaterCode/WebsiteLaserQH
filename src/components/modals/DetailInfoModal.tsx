    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[100] flex flex-col items-center justify-start p-0 overflow-hidden"
        ...
        >
          ...
          {/* Scroll Area */}
          <div 
            className="absolute inset-0 z-[110] overflow-y-auto scrollbar-hide flex flex-col items-center p-4 sm:p-6"
            onClick={onClose}
          >
            <motion.div
              ...
              className="w-full max-w-5xl rounded-3xl relative my-auto"
              style={{
                background: '#050912',
